...
- eight course tracks with multi-lesson arcs, guided lesson flows, track-specific playbooks, and visual practice panels
...
- course library with lesson progress, track-specific lesson playbooks, visual practice panels, guided milestones, quiz checkpoints, and sequential progression
- weekly playlists
...
- deepen lesson authoring so each track gets richer interactive practice variations, more bespoke prompts, and age-banded lesson content
