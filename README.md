...
- eight course tracks with multi-lesson arcs, guided lesson flows, track-specific playbooks, visual practice panels, and age-band aware lesson copy
...
- course library with lesson progress, track-specific lesson playbooks, visual practice panels, age-band aware prompts, guided milestones, quiz checkpoints, and sequential progression
- weekly playlists
...
- deepen lesson authoring so each track gets richer interactive practice variations, more bespoke prompts, and more sharply authored age-banded lesson content
